...
model = torch.jit.load("new_final_mnist_cnn.ts", map_location="cpu")
model.eval()
...
def predict(request: MNISTRequest):
    ...
    return {
        ...
        "featuremap16": featuremap16.cpu().tolist(),
        "featuremap17": featuremap17.cpu().tolist(),
        "featuremap18": featuremap18.cpu().tolist(),
        "featuremap19": featuremap19.cpu().tolist(),
        "featuremap110": featuremap110.cpu().tolist(),
        ...
        "featuremap26": featuremap26.cpu().tolist(),
        "featuremap27": featuremap27.cpu().tolist(),
        "featuremap28": featuremap28.cpu().tolist(),
        "featuremap29": featuremap29.cpu().tolist(),
        "featuremap210": featuremap210.cpu().tolist(),
        ...
        "featuremap36": featuremap36.cpu().tolist(),
        "featuremap37": featuremap37.cpu().tolist(),
        "featuremap38": featuremap38.cpu().tolist(),
        "featuremap39": featuremap39.cpu().tolist(),
        "featuremap310": featuremap310.cpu().tolist(),
    }